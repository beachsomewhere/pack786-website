# Information Pack 786 Leaders Still Need to Provide

- [x] Meeting location — Aspen View Academy, Castle Rock, CO
- [x] Meeting schedule — pack meeting: 1st Tuesday of every month, 6:00–7:30 PM; den meetings coordinated separately per den
- [x] Pack email address(es) — cubscoutpack786crco@gmail.com (shared by Cubmaster + Committee Chair for now)
- [x] Joining fee and annual dues amounts — see /join
- [x] Council registration link — my.scouting.org online registration
- [x] Social media links — Facebook group, Discord
...
- [ ] Final den availability for the upcoming year (depends on enrollment/leadership)
